...
const StoreContextProvider = ({children}) => {
  ...
  const orgAdmin = myUser?.isOrgAdmin
  ...
  const spaceChatDefaultImg = 'https://firebasestorage.googleapis.com/v0/b/deskable-bb146.appspot.com/o/admin%2Fimages%2Fgroup-chat-img.png?alt=media&token=6afc3906-3f1b-4323-b685-7e99f7e28e80&_gl=1*12ymc5t*_ga*MjUyMTY1MTA2LjE2NjQzNzM3MDA.*_ga_CW55HF8NVT*MTY5NzMzNzYyMS4xMjEuMS4xNjk3MzQwMDM1LjE3LjAuMA..'
  ...
  return <StoreContext.Provider value={{ 
    ...
    photoURLPlaceholder, spaceChatDefaultImg,
